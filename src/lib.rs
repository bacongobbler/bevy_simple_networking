...
impl Plugin for ServerPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(NetworkResource::default())
            ...
            .add_system(systems::server_recv_packet_system.in_set(NetworkSystem::Receive))
            .add_system(systems::send_packet_system.in_set(NetworkSystem::Send))
            .add_system(systems::idle_timeout_system.in_set(ServerSystem::IdleTimeout));
    }
}
...
impl Plugin for ClientPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(transport::Transport::new())
            ...
            .add_event::<events::NetworkEvent>()
            .add_system(systems::client_recv_packet_system.in_set(NetworkSystem::Receive))
            .add_system(systems::send_packet_system.in_set(NetworkSystem::Send))
            .add_system(systems::auto_heartbeat_system.in_set(ClientSystem::Heartbeat));
    }
}
